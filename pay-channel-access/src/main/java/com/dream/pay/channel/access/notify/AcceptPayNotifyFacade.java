...
public interface AcceptPayNotifyFacade {
    /**
     * 网关支付－－接受第三方通知
     */
    @POST
    @GET
    @Path("payNotify/{bizLine}/{payType}")
    public void payNotify(@PathParam("bizLine") String bizLine, @PathParam("payType") String payType,
