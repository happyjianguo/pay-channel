...
public class GatePayApplyFacadeImpl implements GatePayApplyFacade {
    ...
    public PayApplyRepDTO payApply(PayApplyReqDTO payApplyReqDTO) {
        log.info("[支付申请]-[{}]-[{}]-[{}]", payApplyReqDTO.getPayType().name(), payApplyReqDTO.getBizOrderNo(),
        ...
        try {
            ...
            log.info("[支付申请][结束]-[{}]-[{}]-[{}]\n{}", payApplyRepDTO.getTradeStatus(), payApplyRepDTO.getChlRtnMsg(),
                    payApplyRepDTO.getChlRepDateTime(), payApplyRepDTO.getRepContent());
            ...
            log.error("[支付申请][发生异常]-[{}]-[{}]", payApplyReqDTO.getPayType().name(), payApplyReqDTO.getBizOrderNo(), e);
        }
